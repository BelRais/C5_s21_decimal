...
Suite *s21_is_less_or_equal_suite(void) {
  Suite *s;
  TCase *ts_core;
  s = suite_create("\033[45m-s21_is_less_or_equal-\033[0m");
  ts_core = tcase_create("case_is_less_or_equal");
  tcase_add_test(ts_core, s21_less_or_equal_1);
  tcase_add_test(ts_core, s21_less_or_equal_2);
  tcase_add_test(ts_core, s21_less_or_equal_3);
  tcase_add_test(ts_core, s21_less_or_equal_4);
  tcase_add_test(ts_core, s21_less_or_equal_5);
  tcase_add_test(ts_core, s21_less_or_equal_6);
  tcase_add_test(ts_core, s21_less_or_equal_7);
  tcase_add_test(ts_core, s21_less_or_equal_8);
