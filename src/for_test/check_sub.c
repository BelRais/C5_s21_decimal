...
Suite *s21_sub_suite(void) {
  ...
  TCase *ts_core;
  s = suite_create(
      "\033[45m-s21_sub-\033[0m");  // создает набор кейсов с заданным именем
  ts_core = tcase_create("case_sub");
  tcase_add_test(ts_core, s21_sub_1);
  tcase_add_test(ts_core, s21_sub_2);
  tcase_add_test(ts_core, s21_sub_3);
  tcase_add_test(ts_core, s21_sub_4);
  tcase_add_test(ts_core, s21_sub_5);
  tcase_add_test(ts_core, s21_sub_6);
  tcase_add_test(ts_core, s21_sub_7);
  tcase_add_test(ts_core, s21_sub_8);
  tcase_add_test(ts_core, s21_sub_9);
  tcase_add_test(ts_core, s21_sub_10);
  tcase_add_test(ts_core, s21_sub_11);
  tcase_add_test(ts_core, s21_sub_12);
  tcase_add_test(ts_core, s21_sub_13);
  tcase_add_test(ts_core, s21_sub_14);
  tcase_add_test(ts_core, s21_sub_15);
  tcase_add_test(ts_core, s21_sub_16);
  tcase_add_test(ts_core, s21_sub_17);
  tcase_add_test(ts_core, s21_sub_21);
  tcase_add_test(ts_core, s21_sub_22);
  tcase_add_test(ts_core, s21_sub_23);
  tcase_add_test(ts_core, s21_sub_24);
  tcase_add_test(ts_core, s21_sub_25);
  tcase_add_test(ts_core, s21_sub_26);
  tcase_add_test(ts_core, s21_sub_27);
  tcase_add_test(ts_core, s21_sub_28);
  tcase_add_test(ts_core, s21_sub_29);
  tcase_add_test(ts_core, s21_sub_30);
  tcase_add_test(ts_core, s21_sub_33);
  tcase_add_test(ts_core, s21_sub_34);
  tcase_add_test(ts_core, s21_sub_35);
  tcase_add_test(ts_core, s21_sub_36);
  tcase_add_test(ts_core, s21_sub_37);
  tcase_add_test(ts_core, s21_sub_38);
  tcase_add_test(ts_core, s21_sub_39);
  tcase_add_test(ts_core, s21_sub_40);
  tcase_add_test(ts_core, s21_sub_41);
  tcase_add_test(ts_core, s21_sub_42);
  tcase_add_test(ts_core, s21_sub_43);
