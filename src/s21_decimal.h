...
int add_function(s21_decimal first_value, s21_decimal second_value,
                 ...
                 int *mind_value);  // из arithmetic.c Расулджан
void add_function2(s21_decimal *result_value);  // из arithmetic.c Расулджан
int add_bit(s21_decimal first_value, s21_decimal second_value,
            s21_decimal *result_value);  // из arithmetic.c Расулджан
...
int mul_function(s21_decimal first_value, s21_decimal second_value,
                 s21_decimal *result_value,
                 int sign);  // из arithmetic.c Расулджан
s21_decimal mul_bits(s21_decimal first_value, s21_decimal second_value,
                     s21_decimal *buffer);  // из arithmetic.c Расулджан
int mul_add_bit(s21_decimal *value1, s21_decimal *value2,
                s21_decimal *result);  // из arithmetic.c Расулджан
int div_value(s21_decimal *first_value, s21_decimal second_value,
              s21_decimal *result_value,
              int scale);  // из arithmetic.c Расулджан
int zero_flag(s21_decimal first_value,
              s21_decimal second_value);  // из arithmetic.c Расулджан
void inverse(s21_decimal *value);  // из arithmetic.c Расулджан
...
int s21_is_less(s21_decimal value1, s21_decimal value2);  // от Данжн Мастера
int s21_is_less_or_equal(s21_decimal, s21_decimal);  // от Данжн Мастера
int s21_is_greater(s21_decimal value_1,
                   s21_decimal value_2);  // от Данжн Мастера
int s21_is_greater_or_equal(s21_decimal value1,
                            s21_decimal value2);  // от Данжн Мастера
int s21_is_equal(s21_decimal value1, s21_decimal value2);  // от Данжн Мастера
int s21_is_not_equal(s21_decimal, s21_decimal);  // от Данжн Мастера

int s21_from_int_to_decimal(int src, s21_decimal *dst);      // from Aigul
int s21_from_float_to_decimal(float src, s21_decimal *dst);  // from Aigul
int s21_from_decimal_to_int(s21_decimal src, int *dst);      // from Aigul
int s21_from_decimal_to_float(s21_decimal src, float *dst);  // from Aigul

int div_ten(s21_decimal *number);  // от Данжн Мастера

int s21_negate(s21_decimal value, s21_decimal *result);  // от Данжн Мастера
int s21_truncate(s21_decimal value, s21_decimal *result);  // от Данжн Мастера
int s21_round(s21_decimal value, s21_decimal *result);  // от Данжн Мастера
int s21_floor(s21_decimal value, s21_decimal *result);  // от Данжн Мастера
